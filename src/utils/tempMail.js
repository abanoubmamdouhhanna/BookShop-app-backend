export const temp = (activationCode,protocol,host) => {
  return `
    <!DOCTYPE html>
                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="center" class="alignment"
                                                                        style="line-height:10px"><img
                                                                            ...
                                                                            src="https://res.cloudinary.com/dj0xqaovt/image/upload/v1679265409/tempMail/ulmqfjjqvzq22qvva65f.png"
                                                        ...
                                                        <table border="0" cellpadding="15" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad">
                                                                    <div align="center" class="alignment"
                                                                        style="line-height:10px"><img
                                                                            alt="Resetting Password" class="fullMobileWidth"
                                                                            src="https://res.cloudinary.com/dj0xqaovt/image/upload/v1679265407/tempMail/q56b5oxlnhwlckmtp4ft.jpg"
                                                                            style="display: block; height: auto; border: 0; width: 374px; max-width: 100%;"
                                                                            title="Resetting Password" width="374" /></div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <div class="spacer_block"
                                                    ...
                                                    <td class="column column-2"
                                                        ...
                                                        <table border="0" cellpadding="10" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad">
                                                                    <div align="center" class="alignment">
                                                                        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.example.com" style="height:43px;width:193px;v-text-anchor:middle;" arcsize="10%" strokeweight="0.75pt" strokecolor="#101" fillcolor="#101"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a
                                                                            href="${protocol}://${host}/auth/confirm/${activationCode}"
                                                                            ...
                                                                            target="_blank"><span
                                                                                style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                    dir="ltr"
                                                                                    style="word-break: break-word; line-height: 32px;">Activate Your
                                                                                    Email address.</span></span></a>
                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="center" class="alignment"
                                                                        style="line-height:10px"><img
                                                                            ...
                                                                            src="https://res.cloudinary.com/dj0xqaovt/image/upload/v1679265408/tempMail/yxwfg9h0dei2ycu3c2jm.png"
                                                                            style="display: block; height: auto; border: 0; width: 680px; max-width: 100%;"
                                                                            ...
                                                                            <tr>
                                                                                <td style="padding:0 2px 0 2px;"><a
                                                                                        ...
                                                                                        target="_blank"><img alt="Facebook"
                                                                                            height="32"
                                                                                            src="https://res.cloudinary.com/dj0xqaovt/image/upload/v1679265405/tempMail/tyhhsgditxlx32aw4ghk.png"
                                                                                ...
                                                                                <td style="padding:0 2px 0 2px;"><a
                                                                                        ...
                                                                                        target="_blank"><img alt="Twitter"
                                                                                            height="32"
                                                                                            src="https://res.cloudinary.com/dj0xqaovt/image/upload/v1679265410/tempMail/a5qlkekezimvup0vhmsk.png"
                                                                                            style="display: block; height: auto; border: 0;"
                                                                                            title="twitter"
                                                                                            width="32" /></a></td>
                                                                                <td style="padding:0 2px 0 2px;"><a
                                                                                        ...
                                                                                        target="_blank"><img alt="Linkedin"
                                                                                            height="32"
                                                                                            src="https://res.cloudinary.com/dj0xqaovt/image/upload/v1679265406/tempMail/mngz2dkotyg2572nu1ij.png"
                                                                                            style="display: block; height: auto; border: 0;"
                                                                                            title="linkedin"
                                                                                            width="32" /></a></td>
                                                                                <td style="padding:0 2px 0 2px;"><a
                                                                                        ...
                                                                                        target="_blank"><img alt="Instagram"
                                                                                            height="32"
                                                                                            src="https://res.cloudinary.com/dj0xqaovt/image/upload/v1679265405/tempMail/wwkkho4wzefhd5xkfswn.png"
                                                                                            style="display: block; height: auto; border: 0;"
                                                                                            title="instagram"
                                                                                            width="32" /></a></td>
                                                                            </tr>
